        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-6 feature-col ">
                    <div class="feature-content rounded">
                        <i class="fab fa-cc-mastercard"></i>
                        <h2>Thanh toán an toàn</h2>
                        <p>
                            khach hàng có thể thanh toán bằng thể ngân hàng
                        </p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 feature-col">
                    <div class="feature-content rounded">
                        ...
                        <p>
                            quý khách yên tâm về dịch vụ của chúng tôi
                        </p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 feature-col">
                    <div class="feature-content rounded">
                        ...
                        <p>
                            có thể đổi trả trong vòng 30 ngày kể từ ngày mua
                        </p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 feature-col">
    ...
    <div class="call-to-action">
        <div class="container-fluid">
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <a href="tel:0355488110">0355488110</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="row align-items-center review-slider normal-slider">
                <div class="col-md-6">
                    <div class="review-slider-item">
                        <div class="review-img">
                            <img src="img/tam3.jpg" alt="Image">
                        </div>
                        <div class="review-text">
                            ...
                            <p>
                                sinh viên cao đẳng nghề bách khoa hà nội
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="review-slider-item">
                        <div class="review-img">
                            <img src="img/hung.jpg" alt="Image">
                        </div>
                        <div class="review-text">
                            <h2>Tên nhân viên</h2>
                            ...
                            <p>
                                snh viên cao đẳng nghề bách khoa hà nội
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="review-slider-item">
                        <div class="review-img">
                            <img src="img/shiper.jpg" alt="Image">
                        </div>
                        <div class="review-text">
                            <h2>Tên đối tác giao hàng</h2>
                            <h3>grap</h3>
                            <div class="ratting">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget">
                        ...
                        <div class="contact-info">
                            ...
                            <p><i class="fa fa-envelope"></i>ngotam858@gamil.com</p>
